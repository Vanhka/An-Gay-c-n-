...
-- HÀM LỌC CHÍNH XÁC (BỎ ROB BASE 1-6)
local function checkRealGem(obj)
    ...
    if text:find("gems") and not isBase then
        return true
    end
    return false
end
...
-- GIAO DIỆN MENU (PHẢI Y HỆT ẢNH KHA GỬI)
